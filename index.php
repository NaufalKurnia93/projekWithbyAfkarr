...
<body>
			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						<div class="col-2">
							<a href="index.php" class="logo m-0 float-start">Portal Berita<span
	...
	<section class="section mt-5">
		<div class="container">
			...
			<div class="row mb-4">
				<div class="col-sm-6">
					<h2 class="posts-entry-title" data-aos="zoom-in-right">Our list</h2>
				</div>
				<div class="col-sm-6 text-sm-end" data-aos="zoom-in-left"><a href="list.php" class="read-more">View All</a></div>
			</div>
			...
			<div class="row">
				...
				?>
					...
					<div class="col-lg-4 mb-4">
						...
						<div class="post-entry-alt mb-5" 
						data-aos="fade-up"
						data-aos-duration="3000">

							<a href="article.php?id=<?= $items[$i]['id'] ?>" class="img-link"><img
									src="<?= $items[$i]['thumbnail'] ?>" alt="Image" class="img-fluid">
							</a>
							<div class="excerpt">
								...
								<p class="doremifasol"><?= $items[$i]['deskripsi'] ?></p>
